...
const STORAGE_KEY = "diamond-fortune-game";
...
export default function DiamondFortune({
  player,
  onCreditsChange,
}) {
...
if (prize.amount > 0) {
  ...
  try {
    ...
    console.error("Error al guardar la jugada de Diamond Fortune:", error);
  }
})();
        }
      }, stopTime);
  ...
  return (
    <main className="page diamond-fortune-page">
      <section
        className={[
          "machine",
      ...
      >
        ...
        <div className="diamond-heading" aria-label="Diamond Fortune">
          <span className="diamond-kicker">FORTUNE AWAITS</span>
          <h1 className="title">DIAMOND FORTUNE</h1>
          <span className="diamond-stars" aria-hidden="true">
            ✦ ✧ ✦ 💎 ✦ ✧ ✦
          </span>
        </div>

        <p className="subtitle">
          DIAMANTES · JACKPOT · BONUS
        </p>
