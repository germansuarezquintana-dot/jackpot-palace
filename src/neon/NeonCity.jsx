...
const STORAGE_KEY = "neon-city-game";
...
if (prize.amount > 0) {
  ...
  return (
    <main className="page neon-city-page">
      <section
        className={[
          "machine",
      ...
      >
        ...
        <div className="neon-city-heading" aria-label="Neon City">
          <span className="neon-city-kicker">WELCOME TO</span>
          <h1 className="title">NEON CITY</h1>
          <span className="neon-city-skyline" aria-hidden="true">
            ▂▅▇▃▆▂▇▅▃▆▇
          </span>
        </div>
